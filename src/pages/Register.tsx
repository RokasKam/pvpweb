...
export default function SignUp() {
  ...
  const validate = (data: any) => {
    ...
    tempErrors.firstName = data.get("firstName") ? "" : "Vardas yra privalomas";
    tempErrors.lastName = data.get("lastName") ? "" : "Pavardė yra privaloma";
    tempErrors.email = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(
      data.get("email") as string
    )
      ? ""
      : "Neteisingas el. pašto adreso formatas";
    tempErrors.school = data.get("school")
      ? ""
      : "Mokyklos pavadinimas yra privalomas";
    tempErrors.password =
